...
import { useXmlFormatter, useXmlCompare } from '@/composables/useXmlFormatter'
...
<template>
  ...
  <SectionDivider v-if="compareXml1 && compareXml2 && !xmlCompareError" icon="list">
    Comparison Result
    <Tag
