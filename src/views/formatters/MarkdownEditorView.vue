...
const copyHtml = () => {
  ...
  toast.add({
    severity: 'success',
    summary: 'Copied',
    detail: 'HTML copied to clipboard',
    life: 2000,
  })
}
...
const generateTocMarkdown = () => {
  if (tableOfContents.value.length === 0) {
    toast.add({
      severity: 'warn',
      summary: 'No headings',
      detail: 'No headings found in the document',
      life: 3000,
    })
    return
  }
  ...
  toast.add({
    severity: 'success',
    summary: 'TOC Generated',
    detail: 'Table of contents added to document',
    life: 2000,
  })
}
  ...
  <Card>
    ...
    <template #content>
      ...
      <TabView>
        ...
        <TabPanel value="1" header="HTML Output">
          <div class="panel-label">
        ...
        <TabPanel value="2" header="Table of Contents">
          <Panel toggleable>
            <template #header>
              <div class="panel-header">
